...
public:
    ...
    static constexpr auto from_code(i32 code) noexcept -> ExitStatus { return { code, true }; }

    /// Construct from a signal number (process was killed).
    static constexpr auto from_signal(i32 sig) noexcept -> ExitStatus { return { sig, false }; }
