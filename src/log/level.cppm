...
namespace detail {
inline constexpr char const* LEVEL_NAMES[] = {
    "OFF", "ERROR", "WARN", "INFO", "DEBUG", "TRACE"
};
}

/// Returns the uppercase string name for a Level.
export [[nodiscard]] inline constexpr auto as_str(Level l) noexcept -> ref<str> {
    return detail::LEVEL_NAMES[static_cast<u32>(l)];
}

/// Returns the uppercase string name for a LevelFilter.
export [[nodiscard]] inline constexpr auto as_str(LevelFilter f) noexcept -> ref<str> {
    return detail::LEVEL_NAMES[static_cast<u32>(f)];
}

// ── comparisons ───────────────────────────────────────────────────────────

export [[nodiscard]] inline constexpr bool operator<=(Level l, LevelFilter f) noexcept {
    return static_cast<u32>(l) <= static_cast<u32>(f);
}

export [[nodiscard]] inline constexpr bool operator<=(LevelFilter f, Level l) noexcept {
...
export [[nodiscard]] inline constexpr auto to_level_filter(Level l) noexcept -> LevelFilter {
    return static_cast<LevelFilter>(static_cast<u32>(l));
}

/// Converts LevelFilter to Level, returning None if Off.
export [[nodiscard]] inline constexpr auto to_level(LevelFilter f) noexcept -> Option<Level> {
...
export [[nodiscard]] inline constexpr auto parse_level(ref<str> s) noexcept -> Option<Level> {
...
export [[nodiscard]] inline constexpr auto parse_level_filter(ref<str> s) noexcept -> Option<LevelFilter> {
