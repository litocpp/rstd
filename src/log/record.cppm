...
export struct MetadataBuilder {
    ...
    auto set_level(Level l) noexcept -> MetadataBuilder& { level = l; return *this; }
    auto set_target(ref<str> t) noexcept -> MetadataBuilder& { target = t; return *this; }
...
export struct RecordBuilder {
    ...
    auto set_metadata(Metadata m) noexcept -> RecordBuilder& { metadata = m; return *this; }
    auto set_level(Level l) noexcept -> RecordBuilder& { metadata.level = l; return *this; }
    auto set_target(ref<str> t) noexcept -> RecordBuilder& { metadata.target = t; return *this; }
    auto set_args(fmt::Arguments a) noexcept -> RecordBuilder& { args = a; return *this; }
    auto set_location(panic_::Location loc) noexcept -> RecordBuilder& { location = loc; return *this; }
